...
namespace E_Commerce.InfraStructure.Data.Migrations
{
    ...
    [Migration("20250912053006_SeedDataDelivary")]
    partial class SeedDataDelivary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce.Core.Entites.Order.DelivaryMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce.Core.Entites.Order.OrderItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce.Core.Entites.Order.Orders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce.Core.Entites.User.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce.Core.Entites.User.AppUser", b =>
                {
            ...
            modelBuilder.Entity("E_Commerce.Core.Entites.Order.OrderItems", b =>
                {
                    b.HasOne("E_Commerce.Core.Entites.Order.Orders", null)
                        .WithMany("orderItems")
            ...
            modelBuilder.Entity("E_Commerce.Core.Entites.Order.Orders", b =>
                {
                    b.HasOne("E_Commerce.Core.Entites.Order.DelivaryMethod", "delivaryMethod")
                        .WithMany()
                        .HasForeignKey("delivaryMethodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("E_Commerce.Core.Entites.Order.ShippingAddress", "shippingAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("E_Commerce.Core.Entites.User.Address", b =>
                {
                    b.HasOne("E_Commerce.Core.Entites.User.AppUser", "AppUser")
                        .WithOne("Address")
                        .HasForeignKey("E_Commerce.Core.Entites.User.Address", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("E_Commerce.Core.Entites.User.AppUser", null)
                        .WithMany()
